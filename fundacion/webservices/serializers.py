...
class PrimeraVezSerializer(serializers.Serializer):
    ...
    # s = serializers.CharField(max_length=4096, allow_blank=True, allow_null=True, required=False)
    ...
    # p = serializers.CharField(max_length=4096, allow_blank=True, allow_null=True, required=False)
    # medio_contacto = serializers.IntegerField()
    # violentometro = serializers.IntegerField(min_value=1, allow_null=True, required=False)
    # tipo_caso = serializers.IntegerField(min_value=1, allow_null=True, required=False)
    ...
    # tipo_llamada = serializers.IntegerField(min_value=1, allow_null=True, required=False)
